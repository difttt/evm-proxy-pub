...
#[get("/")]
async fn arh999() -> String {
    "{\"data\":\"0.31\",\"code\":200,\"msg\":\"success\"}".to_string()
}
...
fn rocket() -> _ {
    ...
    rocket::build().mount("/", routes![index]).mount("/arh999", routes![arh999])
}
...
pub async fn public_task(
    ...
    let contract = Contract::from_json(
        web3.eth(),
        hex!("8093A42f28Cd1697D2176AA75D861c1cD850815f").into(),//DEP（v1.0.4）
